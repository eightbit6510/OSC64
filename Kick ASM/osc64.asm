...
!enter:  //send the message to the ESP32
    ldx #$00
    ldy #$00
!loop:                                            // 
    
                                                  // 
!:      lda $04c8,x                                    // read the character screen code from screen RAM
        and #%01111111
        sta TXBUFFER,y                                // store the character in the buffer

        iny                                           // increase the index for TXBUFFER
        inx                                           // increase the index for reading the screen and color RAM
        cpx #39                                // if x reaches the message lengt value, we are at the end of message,
        bne !loop-                                    // continue to loop while x < message length
        lda #128                                      // load byte 128 in the accumulator
        sta TXBUFFER,y                                // and put it in the buffer as an end marker
    jsr !hide_cursor-                             //  
...
!up_arrow_handler:
    // 1. Save bottom line (line 24) to buffer
    ldx #$00
!save_bottom:
    lda $07c0,x  // last line
    sta TEMP_BUFFER,x
    inx
    cpx #40
    bne !save_bottom-
...
oscdata:              
        .text "/composition/layers/3/clips/1/connect 1 "
        .text "/composition/layers/3/clips/2/connect 1 "
        .text "/composition/layers/3/clips/3/connect 1 "
        .text "/composition/layers/3/clips/4/connect 1 "
        .text "/composition/layers/3/clips/5/connect 1 "
        .text "/composition/layers/3/clips/6/connect 1 "
        .text "/composition/layers/2/clips/1/connect 1 "
        .text "/composition/layers/2/clips/2/connect 1 "
        .text "/composition/layers/2/clips/3/connect 1 "
        .text "/composition/layers/2/clips/4/connect 1 "
        .text "/composition/layers/2/clips/5/connect 1 "
        .text "/composition/layers/2/clips/6/connect 1 "
        .text "/composition/layers/1/clips/1/connect 1 "
        .text "/composition/layers/1/clips/2/connect 1 "
        .text "/composition/layers/1/clips/3/connect 1 "
        .text "/composition/layers/1/clips/4/connect 1 "
        .text "/composition/layers/1/clips/5/connect 1 "
        .text "/composition/layers/1/clips/6/connect 1 "
        .text "/vol 0.1                                "
        .text "/vol 0.5                                "
        .text "/vol 1.0                                "
        .text "/scale 50                               "
...
// VARIABLE BUFFERS
//=========================================================================================================
.segment Variables [start=$3f00, virtual]
